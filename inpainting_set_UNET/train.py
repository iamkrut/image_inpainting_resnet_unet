...
def train_net(net,
    ...
    for epoch in range(epochs):
        ...
        image = str(epoch + 1) + "_train_input_" + ".png"
        plt.imsave(join(data_dir, 'samples', image), images[index,:,:,:3])
        
        image = str(epoch + 1) + "_train_groundtruth_" + ".png"
        plt.imsave(join(data_dir, 'samples', image), labels[index])
        
        image = str(epoch + 1) + "_train_output_" + ".png"
        ...
        image = str(epoch + 1) + "_test_input_" + ".png"
        plt.imsave(join(data_dir, 'samples', image), images[index,:,:,:3])
        
        image = str(epoch + 1) + "_test_groundtruth_" + ".png"
        plt.imsave(join(data_dir, 'samples', image), labels[index])
        
        image = str(epoch + 1) + "_test_output_" + ".png"
        plt.imsave(join(data_dir, 'samples', image), predictions[index])
